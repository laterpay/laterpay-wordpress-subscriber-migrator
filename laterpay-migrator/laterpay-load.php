...
class LaterPay_Migrator_AutoLoader
{
    ...
    public static function register_namespace( $dirName, $namespace ) {
        ...
        LaterPay_Migrator_AutoLoader::$namespaces[] = array(
                                                   'path' => $dirName,
                                                   'name' => $namespace,
                                                );
    }
    ...
    public static function load_class_from_namespace( $class ) {
        ...
        foreach ( LaterPay_Migrator_AutoLoader::$namespaces as $namespace ) {
    ...
    public static function register_directory( $dirName ) {
        LaterPay_Migrator_AutoLoader::$paths[] = $dirName;
        set_include_path(
            implode(
                PATH_SEPARATOR,
                array(
    ...
    public static function load_class( $class ) {
        ...
        foreach ( LaterPay_Migrator_AutoLoader::$paths as $path ) {
...
spl_autoload_register( array( 'LaterPay_Migrator_AutoLoader', 'load_class' ), false );
spl_autoload_register( array( 'LaterPay_Migrator_AutoLoader', 'load_class_from_namespace' ), false );
